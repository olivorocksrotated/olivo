                    ...
                    <div>
                        {
                            ...
                            commitment.status === CommitmentStatus.Done ? <DoneStatusMarker /> : null
                        }
                    </div>
                </button>
            </Popover.Trigger>
